...
public final class ExportTaskRequestFingerprintUtil {
     ...
     * 基于业务侧可见字段构建请求指纹。
     */
    public static String build(ExportTaskDTO dto) {
        StringBuilder builder = new StringBuilder(256);
        builder.append("businessSystem=").append(normalizeText(dto == null ? null : dto.getBusinessSystem())).append(';');
        builder.append("businessType=").append(normalizeText(dto == null ? null : dto.getBusinessType())).append(';');
        builder.append("taskName=").append(normalizeText(dto == null ? null : dto.getTaskName())).append(';');
        builder.append("fileName=").append(normalizeText(dto == null ? null : dto.getFileName())).append(';');
        builder.append("creator=").append(normalizeText(dto == null ? null : dto.getCreator())).append(';');
        builder.append("extMap=");
        appendCanonicalValue(builder, dto == null ? null : dto.getExtMap());
