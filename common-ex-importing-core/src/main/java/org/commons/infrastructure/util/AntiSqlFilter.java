 ...
 * Defaults to <i>false</i>. <br>
 * <br>
 * <b>behavior</b> - there are three possible behaviors in case of a SQL Injection detection:
 * <li>protect : (default) dangerous SQL keywords are 2nd character supressed / dangerous SQL delimitters are blank
 * space replaced. Afterwards the request flows as expected.
 * <li>throw: a ServletException is thrown - breaking the request flow.
 * <li>forward: thre request is forwarded to a specific resource. <br>
 * <br>
...
public class AntiSqlFilter {
    ...
    private static final String[] KEY_WORDS = {";", "\"", "\'", "/*", "*/", "--", "exec", "select", "update", "delete", "insert", "alter", "drop", "create", "shutdown"};
