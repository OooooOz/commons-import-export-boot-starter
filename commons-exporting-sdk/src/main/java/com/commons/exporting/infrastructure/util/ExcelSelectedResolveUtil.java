package com.commons.exporting.infrastructure.util;

import com.alibaba.excel.annotation.ExcelProperty;
import com.commons.exporting.infrastructure.handle.ExcelSelected;
import com.commons.exporting.infrastructure.handle.ExcelSelectedResolve;
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            if (selected != null) {
                ...
                if (source != null && source.length > 0) {
                    ...
                    if (property != null && property.index() >= 0) selectedMap.put(property.index(), excelSelectedResolve);
                    else selectedMap.put(i, excelSelectedResolve);
                }
            }
        }
        return selectedMap;
